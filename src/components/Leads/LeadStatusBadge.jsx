...
export const getLocalizedStatus = (statusKey, t) => {
  const map = {
    new: t('leads.statusNew'),
    'in-progress': t('leads.statusInProgress'),
...
export const LeadStatusBadge = ({ leadId, status = 'new', editable = true }) => {
  ...
  const currentLabel = getLocalizedStatus(status, t);
  ...
  return (
    <div className="relative inline-block">
      ...
      >
        ...
        {editable && <ChevronDown className="w-3 h-3 opacity-60 ml-0.5 rtl:ml-0 rtl:mr-0.5" />}
      </button>
